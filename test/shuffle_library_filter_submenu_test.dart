...
//
// SKIPPED: Widget test environment hangs when sqflite_common_ffi opens
// a database inside a Flutter test isolate (TestDeviceException / SIGTERM).
// The PlaylistDatabase constructor + getGenreClusterCounts call in the
// widget's initState never completes in this context. Triage result:
// "Test infrastructure issue — test setup hangs in the widget test
// environment, not a bug in the production code."
// Revisit when the Flutter test runner or sqflite_common_ffi is upgraded.
...
void main() {
  ...
  group('(skipped) sqflite_common_ffi hangs in widget test environment',
      skip: true, () {
