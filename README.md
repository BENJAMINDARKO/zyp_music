...
- **Now-playing card** — home screen shows the current track with thumbnail, controls, and progress bar
- **Lockscreen controls** — Android MediaSession configured for lockscreen playback controls
- **Notification** — Android 13+ media notification permission included
