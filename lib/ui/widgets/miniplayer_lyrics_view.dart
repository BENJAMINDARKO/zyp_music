                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () =>
                            provider.setAutoScroll(!provider.autoScroll),
                        tooltip: 'Toggle Auto-Scroll',
                      ),
                      IconButton(
                        icon: Icon(
                          Icons.mic_external_on,
                          color: provider.isKaraokeMode
                              ? activeColor
                              : Colors.white70,
                        ),
                        onPressed: () =>
                            provider.setKaraokeMode(!provider.isKaraokeMode),
                ...
                Expanded(
                  child: provider.isLoadingLyrics || provider.lyrics != null
                      ? ValueListenableBuilder<Duration>(
                          ...
                          builder: (_, position, _) => provider.isKaraokeMode
                              ? SyncedLyricsWidget(
